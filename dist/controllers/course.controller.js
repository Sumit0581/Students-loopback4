    ...
    rest_1.post('/courses', {
        responses: {
            '200': {
                ...
                content: { 'application/json': { schema: { 'x-ts-type': models_1.Course } } },
            },
        },
    }),
    __param(0, rest_1.requestBody()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [models_1.Course]),
    ...
    rest_1.get('/courses', {
        responses: {
            '200': {
                ...
                content: {
                    'application/json': {
                        schema: { type: 'array', items: { 'x-ts-type': models_1.Course } },
                    },
                },
            },
        },
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, models_1.Course]),
    __metadata("design:returntype", Promise)
